            ...
            <div className="p-8">
              ...
              {isSuccess ? (
                <div className="py-12 text-center">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">{t.contact.success_title}</h3>
                  <p className="text-slate-500 dark:text-slate-400">{t.contact.success_text}</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest text-slate-400">
                      <span className="bg-white dark:bg-slate-900 px-4">{t.contact.or_form}</span>
                    </div>
                  </div>
